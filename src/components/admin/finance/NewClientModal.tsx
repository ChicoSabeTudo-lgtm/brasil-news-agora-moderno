      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className="space-y-1.5">
            <Label className="flex items-center gap-2 text-sm font-medium text-muted-foreground"><User className="w-4 h-4" /> Nome do Cliente *</Label>
        ...
        <DialogFooter className="mt-2">
          ...
          <Button onClick={handleCreate} disabled={!canSave}>{saving ? 'Criando...' : 'Criar Cliente'}</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
