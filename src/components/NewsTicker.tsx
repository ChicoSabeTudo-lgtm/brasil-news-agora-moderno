...
export const NewsTicker = () => {
  ...
  return <div className="bg-news-ticker text-white border-b border-gray-700">
      {/* Breaking News Ticker */}
      {!loading && breakingNews.length > 0 && <div className="border-b border-gray-600 py-2 bg-slate-950">
            ...
            <div className="flex items-center">
              ...
              <div className="flex-1 overflow-hidden">
                <div className="animate-marquee whitespace-nowrap">
                  {breakingNews.map(news => <a key={news.id} href={`/${news.categories.slug}/${news.slug}`} className="text-sm mr-8 hover:text-primary transition-colors cursor-pointer">
                      {news.title}
                    </a>)}
                </div>
              </div>
