// ============================================
// NEWS API - VERSÃO COMPLETA (GET + POST)
// ============================================
// Esta versão aceita tanto buscar quanto criar notícias
// ============================================
...
serve(async (req) => {
  ...
  try {
    ...
    const SUPABASE_SERVICE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNwZ3VzanJqcmhmeWNoaGR3aXhuIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MTgxMzA4MCwiZXhwIjoyMDY3Mzg5MDgwfQ.YOUR_SERVICE_ROLE_KEY_HERE';
    ...
    // Cliente para escrita (service key)
    ...
    if (req.method === 'GET') {
      ...
      console.log('📋 GET - Parâmetros:', { limit, offset, category, search });
      ...
      try {
        ...
        // Enriquecer com categorias e imagens
        let categoriesMap = {};
        let imagesMap = {};
        ...
        try {
          ...
          console.warn('⚠️ Erro ao buscar dados adicionais:', error);
        }
        ...
        console.log('🎉 GET - Retornando', enrichedData.length, 'notícias');
      ...
      try {
        ...
        const { data: newsData, error: newsError } = await supabaseAdmin
          ...
          .insert({
            ...
            is_featured: false,
            is_published: false, // Sempre como rascunho
        ...
        console.log('🎉 POST - Notícia criada com sucesso');
